...
@section('content')
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="row" action="#" id="UpdateForm" method="post">
                        @csrf
                        <input type="hidden" class="setnull" name="id" id="itemId">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control setnull" name="image" placeholder="Image"
                                   id="image">
                        </div>
    ...
    <script>
        ...
        window.operateEvents = {
            'click .edit': function (e, value, item, index) {
                $('#itemId').val(item.id)
